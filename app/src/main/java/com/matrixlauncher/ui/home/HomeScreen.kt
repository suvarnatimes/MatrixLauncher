...
fun HomeScreen(
    ...
    Box(
        ...
        FreeFormWidgetsContainer(
            ...
            crossSizeScale = crossSizeScale,
            nameSizeScale = nameSizeScale,
            timeSizeScale = timeSizeScale,
            dateSizeScale = dateSizeScale,
            batterySizeScale = batterySizeScale,
            ...
            onCycleBibleVerse = onCycleBibleVerse,
