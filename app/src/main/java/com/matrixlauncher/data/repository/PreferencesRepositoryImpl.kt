...
class PreferencesRepositoryImpl @Inject constructor(
    ...
    override val settingsFlow: Flow<LauncherSettings> = preferencesManager.settingsFlow
    ...
    override suspend fun setAgslShaderEnabled(enabled: Boolean) {
        preferencesManager.setAgslShaderEnabled(enabled)
    }

    override suspend fun setCrtScanlinesEnabled(enabled: Boolean) {
        preferencesManager.setCrtScanlinesEnabled(enabled)
    }

    override suspend fun setAutoFocusSearch(enabled: Boolean) {
        preferencesManager.setAutoFocusSearch(enabled)
    }

    override suspend fun setMaxFavoritesCount(count: Int) {
        preferencesManager.setMaxFavoritesCount(count)
    }

    override suspend fun setMindfulPauseSeconds(seconds: Int) {
        preferencesManager.setMindfulPauseSeconds(seconds)
    }

    override suspend fun toggleMindfulApp(packageName: String) {
        preferencesManager.toggleMindfulApp(packageName)
    }
    ...
    override suspend fun removeFavorite(packageName: String) {
        preferencesManager.removeFavorite(packageName)
    }
}
